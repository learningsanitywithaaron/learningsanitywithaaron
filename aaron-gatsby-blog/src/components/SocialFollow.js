...
export default function SocialFollow({ size, color, includeHandle = true }) {
  ...
  const socialToIconMap = {
    youtube: { icon: faYoutube, link: 'https://www.youtube.com/' },
    twitter: { icon: faTwitter, link: 'https://twitter.com/' },
    instagram: { icon: faInstagram, link: 'https://instagram.com/' },
    twitch: { icon: faTwitch, link: 'https://www.twitch.tv/' },
  }
    ...
    <div className='social-follow'>
      {includeHandle && (
        <p className={'social-follow-text text-' + color}>
          @ifiwere<strong>a</strong>writer
        </p>
      )}
      <div className='flex'>
